...
void goingUp(int timer);
void drunk (int timer);
void noGravity(int timer);
void kickLeft(int timer);
void kickRight(int timer);
...
void lateral_fuerte(boolean side, int timer){
...
void drunk (int timer){
  ...
  moveNServos(timer*0.235,move1);
  moveNServos(timer*0.235,move2);
  moveNServos(timer*0.235,move3);
  moveNServos(timer*0.235,move4);
  while(millis()<(pause+timer));
...
void noGravity(int timer){
  ...
  moveNServos(timer*2,move1);
  moveNServos(timer*2,move2);
  delay(timer*2);
  moveNServos(timer*2,move3);
  moveNServos(timer*2,move4);
...
void kickLeft(int timer){
  for(int i=0;i<4;i++) servo[i].SetPosition(90);
  delay(timer);
  servo[0].SetPosition(50); //right foot
  servo[1].SetPosition(70); //left foot
  delay(timer);
  servo[0].SetPosition(80); //right foot
  servo[1].SetPosition(70); //left foot
  delay(timer/4);
  servo[0].SetPosition(30); //right foot
  servo[1].SetPosition(70); //left foot
  delay(timer/4);
  servo[0].SetPosition(80); //right foot
  servo[1].SetPosition(70); //left foot
...
for(int i=0;i<4;i++) servo[i].SetPosition(90);
  delay(timer);
  servo[0].SetPosition(110); //right foot
  servo[1].SetPosition(130); //left foot
  delay(timer);
  servo[0].SetPosition(110); //right foot
  servo[1].SetPosition(100); //left foot
  delay(timer/4);
  servo[0].SetPosition(110); //right foot
  servo[1].SetPosition(150); //left foot
  delay(timer/4);
  servo[0].SetPosition(110); //right foot
  servo[1].SetPosition(80); //left foot
  delay(timer/4);
  servo[0].SetPosition(110); //right foot
  servo[1].SetPosition(150); //left foot
  delay(timer/4);
